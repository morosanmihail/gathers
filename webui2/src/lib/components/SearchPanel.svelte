...
<div class="search-panel">
	...
	<form onsubmit={(e) => { e.preventDefault(); onsubmit(); }}>
		...
		{#if showMtg}
			<div class="filter-section filter-section-mtg">
				<h3 class="filter-section-title">Magic: The Gathering</h3>
		...
		{#if showRift}
			<div class="filter-section filter-section-riftbound">
				<h3 class="filter-section-title">Riftbound</h3>
		...
		{#if showPoke}
			<div class="filter-section filter-section-pokemon">
				<h3 class="filter-section-title">Pokémon</h3>
...
<style>
	...
	.filter-section .field:last-child { margin-bottom: 0; }
	...
	.filter-section-riftbound { --game-accent: #8891e0; }
	.filter-section-pokemon   { --game-accent: #e07a5f; }
</style>
